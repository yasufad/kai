# Kai: Quotas and Pricing

Kai offers a generous free tier that covers the use cases for many individual
...
This article outlines the specific quotas and pricing applicable to the Kai CLI
...
### Log in with Google (Kai Code Assist for individuals)

For users who authenticate by using their Google account to access Kai Code
Assist for individuals. This includes:

- 1000 model requests / user / day
- 60 model requests / user / minute
- Model requests will be made across the Kai model family as determined by Kai.

Learn more at
[Kai Code Assist for Individuals Limits](https://developers.google.com/gemini-code-assist/resources/quotas#quotas-for-agent-mode-gemini-cli).

### Log in with Kai API Key (Unpaid)

If you are using a Kai API key, you can also benefit from a free tier. This
includes:
...
Learn more at
[Kai API Rate Limits](https://ai.google.dev/gemini-api/docs/rate-limits).
...
Kai by upgrading to one of the following subscriptions:

- [Google AI Pro and AI Ultra](https://cloud.google.com/products/gemini/pricing)
  by signing up at
  [Set up Kai Code Assist](https://goo.gle/set-up-gemini-code-assist). This is
  ...
  Learn more at
  [Kai Code Assist Quotas and Limits](https://developers.google.com/gemini-code-assist/resources/quotas)

- [Purchase a Kai Code Assist Subscription through Google Cloud ](https://cloud.google.com/gemini/docs/codeassist/overview)
  by signing up in the Google Cloud console. Learn more at
  [Set up Kai Code Assist](https://cloud.google.com/gemini/docs/discover/set-up-gemini)
  ...
  This includes:
  - Kai Code Assist Standard edition:
    - 1500 model requests / user / day
    - 120 model requests / user / minute
  - Kai Code Assist Enterprise edition:
    - 2000 model requests / user / day
    - 120 model requests / user / minute
  - Model requests will be made across the Kai model family as determined by
    Kai.

  [Learn more about Kai Code Assist Standard and Enterprise license limits](https://developers.google.com/gemini-code-assist/resources/quotas#quotas-for-agent-mode-gemini-cli).

## Pay As You Go

If you hit your daily request limits or exhaust your Kai Pro quota even after
...
To do this, log in using a Kai API key or Vertex AI.
...
Learn more at
[Kai API Rate Limits](https://ai.google.dev/gemini-api/docs/rate-limits),
[Kai API Pricing](https://ai.google.dev/gemini-api/docs/pricing)
...
## Kai for Workspace plans

These plans currently apply only to the use of Kai web-based products provided
by Google-based experiences (for example, the Kai web app or the Flow video
editor). These plans do not apply to the API usage which powers the Kai.
...
- Vertex AI: This is the enterprise-grade platform for building, deploying, and
  managing Gemini models with specific security and control requirements. Kai
