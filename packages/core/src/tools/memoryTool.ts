...
export const DEFAULT_CONTEXT_FILENAME = 'KAI.md';
export const MEMORY_SECTION_HEADER = '## Kai Added Memories';

// This variable will hold the currently configured filename for KAI.md context files.
