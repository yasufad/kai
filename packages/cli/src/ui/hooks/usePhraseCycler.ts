...
export const INFORMATIVE_TIPS = [
  ...
  'Choose a specific Kai model for conversations (/settings)...',
  ...
  'Show Kai status in the terminal window title (/settings)...',
  ...
  'Submit your prompt to Kai with Enter...',
  ...
  'Create a project-specific KAI.md file with /init...',
  ...
  'Reload instructional context from KAI.md files with /memory refresh...',
  'List the paths of the KAI.md files in use with /memory list...',
