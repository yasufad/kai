...
the Kai. They execute the built binary in a controlled environment and verify
...
The workflow runs the tests in different sandboxing environments to ensure Kai
