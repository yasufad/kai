...
/**
 * Traverses upward from startDir to stopDir, finding all KAI.md variants.
 *
...
/**
 * Loads hierarchical KAI.md files and concatenates their content.
...
export async function loadServerHierarchicalMemory(
  ...
  if (filePaths.length === 0) {
    if (debugMode)
      logger.debug('No KAI.md files found in hierarchy of the workspace.');
