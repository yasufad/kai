  ...
  - **Sub-commands:**
    ...
    - **`refresh`**:
      - **Description:** Reload the hierarchical instructional memory from all
        `KAI.md` files found in the configured locations (global,
        project/ancestors, and sub-directories). This command updates the model
        with the latest `KAI.md` content.
    - **`list`**:
      - **Description:** Lists the paths of the KAI.md files in use for
        hierarchical memory.
    - **Note:** For more details on how `KAI.md` files contribute to
